    ...
    <Card className="shadow-md bg-white">
      <CardHeader className="pb-2">
        ...
        <p className="text-slate-500 text-xs mt-1 text-center">
          ...
          {/* <a
              href="https://sehatnegeriku.kemkes.go.id/baca/umum/20250526/2247848/ssgi-2024-prevalensi-stunting-nasional-turun-menjadi-198/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 underline hover:text-blue-800"
            >
              <br></br>Sumber :
              https://sehatnegeriku.kemkes.go.id/baca/umum/20250526/2247848/ssgi-2024-prevalensi-stunting-nasional-turun-menjadi-198/
            </a> */}
        </p>
      </CardHeader>
      <CardContent>
        <div ref={containerRef} style={{ height: `${data.length * 60}px`, width: "100%" }}>
            ...
            >
              ...
              <Bar
                ...
                background={({ x, y, width, height }) => (
                  <rect x={x} y={y} width={width} height={height} fill="#E5E7EB" rx={10} ry={10} />
                )}
              >
                <LabelList
                  content={({ x = 0, y = 0, index }) => {
                    ...
                    return (
                      <>
                        ...
                        <text x={x} y={y - 5} fill="#111827" fontSize={12} fontWeight={500} textAnchor="start">
                          {item.name}
                        </text>
