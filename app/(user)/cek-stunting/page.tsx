  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <div className="text-center mb-10">
        <h1 className="text-2xl md:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-primary">
            ...
            <div className="lg:col-span-2">
              <Card className="overflow-hidden shadow-md border-blue-100 dark:border-blue-900">
                <CardHeader className="text-center bg-input from-blue-50 to-cyan-50 dark:from-blue-950/50 dark:to-cyan-950/50 border-b border-blue-100 dark:border-blue-900">
                  ...
                  <CardDescription>
                    Masukkan data anak dengan lengkap untuk mendapatkan hasil
                    yang akurat
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleSelectChange("kabupatenId", value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleSelectChange("kecamatanId", value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleSelectChange("desaId", value)
                          }
        ...
        <TabsContent value="result">
          {result && (
            <div className="space-y-8">
              <Card className="shadow-lg border-blue-100 dark:border-blue-900 overflow-hidden">
                <CardHeader
                  className={cn(
                    ...
                    result.status === "normal"
                      ? "bg-gradient-to-r from-green-50 to-green-100 dark:from-green-950/30 dark:to-green-900/30 border-green-100 dark:border-green-800"
                      : result.status === "berisiko"
                      ? "bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-950/30 dark:to-yellow-900/30 border-yellow-100 dark:border-yellow-800"
                      : "bg-gradient-to-r from-red-50 to-red-100 dark:from-red-950/30 dark:to-red-900/30 border-red-100 dark:border-red-800"
                  )}
                >
                  <CardTitle
                    className={
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-2">
                          {result.recommendations.map((rec, index) => (
                            <li
                              key={index}
                              className="flex items-start space-x-2 bg-blue-50 dark:bg-blue-950/30 p-3 rounded-md"
                            >
                      ...
                      <div className="space-y-5">
                        {result.recommendedArticles.map((article) => (
                          <Link
                            ...
                            key={article.id}
                          >
                            <div className="p-3 border border-blue-100 dark:border-blue-800 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors cursor-pointer shadow-sm hover:shadow-md mb-3">
                              <div className="flex items-center justify-between">
                ...
                <CardFooter className="bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-800 p-4 flex flex-wrap gap-2 justify-center mb-5">
                  ...
                  <Button
                    ...
                    className="bg-white border-blue-200 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/50"
                  >
              ...
              {/* WHO Chart */}
              <Card className="shadow-lg border-blue-100 dark:border-blue-900 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/50 dark:to-cyan-950/50 border-b border-blue-100 dark:border-blue-900">
                ...
                <CardContent className="p-6">
                  <div className="space-y-6">
                      ...
                      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-md text-sm space-y-2">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                          <li>
                            ...
                            – Berat badan sangat rendah. Anak lebih ringan dari
                            97% anak seusianya. Indikasi gizi buruk dan risiko
                            stunting berat.
                          </li>
                          <li>
                            ...
                            – Berat badan rendah. Masih dalam kategori aman tapi
                            perlu dipantau. Bisa menjadi tanda awal kekurangan
                            gizi.
                          </li>
                          <li>
                            ...
                            – Berat badan rata-rata (median). Anak tumbuh sesuai
                            rata-rata populasi WHO.
                          </li>
                          <li>
                            <span className="text-orange-600 font-medium">
                              Persentil 85
                            </span>{" "}
                            – Berat badan lebih tinggi dari rata-rata. Waspadai
                            potensi kelebihan berat atau gizi berlebih.
                          </li>
                          <li>
                            <span className="text-red-600 font-medium">
                              Persentil 97
                            </span>{" "}
                            – Berat badan sangat tinggi. Anak lebih berat dari
                            97% anak seusianya. Bisa menjadi indikasi obesitas.
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="p-4 rounded-md bg-gray-50 dark:bg-gray-900/50 text-sm leading-relaxed">
                        <p>
