...
export default function CekStunting() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Panggil fungsi prediksi dari lib/ml-integration.ts
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <CardContent className="p-6">
              <Tabs defaultValue="form" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-6">
                  <TabsTrigger value="form">Form Input Data</TabsTrigger>
                  <TabsTrigger value="quick">Prediksi Cepat</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="quick">
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="quick-usia">Usia (bulan)</Label>
                        <Select>
                          <SelectTrigger>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="7-12">7-12 bulan</SelectItem>
                            <SelectItem value="13-24">13-24 bulan</SelectItem>
                            <SelectItem value="25-36">25-36 bulan</SelectItem>
                            <SelectItem value="37-48">37-48 bulan</SelectItem>
                            <SelectItem value="49-60">49-60 bulan</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup defaultValue="laki-laki">
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="laki-laki" id="quick-laki-laki" />
                            <Label htmlFor="quick-laki-laki">Laki-laki</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="perempuan" id="quick-perempuan" />
                            <Label htmlFor="quick-perempuan">Perempuan</Label>
                          </div>
                        </RadioGroup>
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="quick-beratBadan">Berat Badan (kg)</Label>
                        <Input
                          id="quick-beratBadan"
                          type="number"
                          placeholder="Masukkan berat badan"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="quick-tinggiBadan">Tinggi Badan (cm)</Label>
                        <Input
                          id="quick-tinggiBadan"
                          type="number"
                          placeholder="Masukkan tinggi badan"
                          step="0.1"
                          min="0"
        ...
        <div className="lg:col-span-1">
          <Card className="bg-blue-50 dark:bg-blue-900/30 border-blue-100 dark:border-blue-800">
            <CardHeader>
              <CardTitle className="text-lg">Mengapa Cek Stunting Penting?</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-blue-600 dark:text-blue-400 mt-0.5" />
                  <p className="text-sm">
                    <span className="font-medium">Rekomendasi Tepat:</span> Dapatkan saran nutrisi dan perawatan yang
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <div className="mb-6">
                    <h3 className="font-semibold text-lg mb-2">Hasil Analisis</h3>
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-4">Artikel Rekomendasi</h3>
                      ...
                      <Link href={`/edukasi/${article.id}`} key={article.id}>
                        <div className="p-3 border rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors cursor-pointer">
                          <div className="flex items-center justify-between">
                            <h4 className="font-medium text-blue-600 dark:text-blue-400">{article.title}</h4>
