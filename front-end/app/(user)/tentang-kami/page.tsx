  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-6xl">
      <div className="text-center mb-5">
        ...
        <p className="text-muted-foreground dark:text-gray-400 text-sm md:text-xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 px-5">
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-4">
            <div className=" bg-blue-100 dark:bg-blue-900/50 p-2 rounded-full ">
              <Target className="h-6 w-6 text-secondary dark:text-blue-400" />
            </div>
          ...
          <p className="text-muted-foreground dark:text-gray-400 text-sm max-sm:text-justify">
          ...
          <div className="flex items-center gap-3 mt-8 mb-4">
            <div className="bg-blue-100 dark:bg-blue-900/50 p-2 rounded-full">
              <BookOpen className="h-6 w-6 text-secondary dark:text-blue-400" />
            </div>
            <h2 className=" text-2xl font-bold text-primary dark:text-blue-300">
          ...
          <ul className="space-y-4">
            <li className="flex items-start space-x-3 bg-input dark:bg-blue-950/30 p-4 rounded-lg">
              <CheckCircle className="mt-1 h-5 w-5 text-secondary dark:text-blue-400 flex-shrink-0" />
            ...
            <li className="flex items-start space-x-3 bg-input dark:bg-blue-950/30 p-4 rounded-lg">
              <ArchiveRestore className="mt-1 h-5 w-5 text-secondary dark:text-blue-400 flex-shrink-0" />
              <span className=" text-gray-700 dark:text-gray-300">
            ...
            <li className="flex items-start space-x-3 bg-input dark:bg-blue-950/30 p-4 rounded-lg">
              <NotepadText className="mt-1 h-5 w-5 text-secondary dark:text-blue-400 flex-shrink-0" />
              <span className="text-gray-700 dark:text-gray-300">
            ...
            <li className="flex items-start space-x-3 bg-input dark:bg-blue-950/30 p-4 rounded-lg">
              <Users className="mt-1 h-5 w-5 text-secondary dark:text-blue-400 flex-shrink-0" />
              <span className="text-gray-700 dark:text-gray-300">
            ...
            <li className="flex items-start space-x-3 bg-input dark:bg-blue-950/30 p-4 rounded-lg">
              <Contact className="h-5 w-5 text-secondary dark:text-blue-400 mt-1 flex-shrink-0" />
              <span className="text-gray-700 dark:text-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-input from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-xl p-6 shadow-md border border-blue-100 dark:border-blue-900 flex flex-col items-center justify-center text-center">
            <div className="bg-blue-100 dark:bg-blue-900/50 p-3 rounded-lg mb-4">
              <Award className="h-8 w-8 text-secondary dark:text-blue-400" />
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <CardContent className="p-6 text-center relative bg-white dark:bg-gray-950 mb-5">
                <h3 className="text-xl font-semibold mb-1 text-secondary dark:text-blue-300">
                  {member.name}
                </h3>
